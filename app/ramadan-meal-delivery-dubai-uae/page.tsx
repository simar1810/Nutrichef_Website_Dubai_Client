...
import { ramadanMealDeliveryDubaiUae } from "@/content/blogs/ramadan-meal-delivery-dubai-uae";
import { extractTableOfContents } from "@/lib/blog/utils";
import { buildPageMetadata } from "@/lib/metadata";

const PATH = "/ramadan-meal-delivery-dubai-uae";
const post = ramadanMealDeliveryDubaiUae;
...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    "Ramadan meal delivery Dubai",
    "iftar meal plan Dubai",
    "suhoor meal delivery UAE",
    "healthy Ramadan meals Abu Dhabi",
    "Ramadan meal plan Sharjah",
    "NutriChef Ramadan",
  ],
});
...
export default function RamadanMealDeliveryDubaiUaePage() {
